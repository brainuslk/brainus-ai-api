...
<Tabs items={['Node.js', 'Python', 'Go']}>
  <Tab value="Node.js">
    ...
    const client = new BrainusAI(); // Reads BRAINUS_API_KEY automatically
  ...
  <Tab value="Python">
    ...
    async def main():
        async with BrainusAI() as client:  # Reads BRAINUS_API_KEY automatically
...
- **[Quick Start Guide](/docs/quick-start)** - Make your first API call
