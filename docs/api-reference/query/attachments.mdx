...
<Callout type="warn">
  Attachment support is available via the REST API only. The official Python and
  JavaScript SDKs do not yet support this endpoint. Use direct HTTP requests as
  shown below.
</Callout>
