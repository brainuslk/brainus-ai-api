...
<TypeTable
  type={{
    ...
    store_id: {
      description: 'Knowledge base identifier (use "default"). Optional - uses default store if not provided.',
      type: "string",
      required: false,
    },
    filters: {
    ...
    model: {
      description: "Model to use for generation. Must be in your plan's allowed_models.",
      type: "string",
      required: false,
    },
  }}
...
<TypeTable
  type={{
    ...
    pages: {
      description: "Array of page numbers where content was found (empty array if unavailable)",
      type: "array",
      required: true,
    },
    metadata: {
      description: "Additional metadata about the citation (empty object if unavailable)",
      type: "object",
      required: true,
    },
    chunk_text: {
      description: "Relevant text excerpt from the source document (may be null)",
      type: "string",
      required: false,
    },
  }}
